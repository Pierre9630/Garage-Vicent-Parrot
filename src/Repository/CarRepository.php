...
class CarRepository extends ServiceEntityRepository
{
    ...
    public function generateReference(): string
    {
        ...
        $month = $today->format('m'); // Month 2 digit format Mois sous forme de deux chiffres
        $day = $today->format('d');   // Day 2 digit format Jour sous forme de deux chiffres
        $year = $today->format('y'); // Year 2 digit format Année sous forme de deux chiffres

        // Get latest day reference number Récupérer le dernier numéro de référence pour la journée actuelle
    ...
    {
        //$today = new \DateTimeImmutable();
        $month = $date->format('m'); // Month on 2 digit format Mois sous forme de deux chiffres
        $day = $date->format('d');   // Day on 2 digit format Jour sous forme de deux chiffres

        // Get latest day reference number Récupérez le dernier numéro de référence pour la journée actuelle
    ...
    public function getLastReferenceForToday(): int
    {
        ...
        // If no reference for today return 0 S'il n'y a pas de référence pour aujourd'hui retourne 0.
        return 0;
    }
//    /**
